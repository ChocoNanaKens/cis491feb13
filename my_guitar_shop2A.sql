...
CREATE USER IF NOT EXISTS 'guitar_shop_app'@'localhost'
IDENTIFIED BY 'pa55word';

GRANT SELECT, INSERT, DELETE, UPDATE
ON my_guitar_shop2.*
TO 'guitar_shop_app'@'localhost';
